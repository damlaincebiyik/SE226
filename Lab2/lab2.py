...
words = [
    ...
    "eat", "economic", "economy", "edge", "education", "effect", "effort", 
    ...
    "five", "floor", "fly", "focus", "follow", "food", "foot", "for", 
    ...
    "group", "grow", "growth", "guess", "gun", "guy", "hair", "half", 
    "hand", "hang", "happen", "happy", "hard", "have", "he", "head", 
    "health", "hear", "heart", "heat", "heavy", "help", "her", "here", 
    "herself", "high", "him", "himself", "his", "history", "hit", "hold", 
    ...
    "in", "include", "including", "increase", "indeed", "indicate", 
    ...
    "Mr", "Mrs", "much", "music", "must", "my", "myself", "name", 
    "nation", "national", "natural", "nature", "near", "nearly", 
    "necessary", "need", "network", "never", "new", "news", "newspaper", 
    "next", "nice", "night", "no", "none", "nor", "north", "not", 
    "note", "nothing", "notice", "now", "n't", "number", "occur", "of", 
    ...
    "require", "research", "resource", "respond", "response", 
    "responsibility", "rest", "result", "return", "reveal", "rich", 
    ...
    "several", "sex", "sexual", "shake", "share", "she", "shoot", 
    ...
    "truth", "try", "turn", "TV", "two", "type", "under", 
...
print("The words that start with letter 'e':")
for word in words:
    if word.startswith('e'):
        print(word)

print("\nThe words that start with letters 'ha':")
for word in words:
